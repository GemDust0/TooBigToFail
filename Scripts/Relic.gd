...
const lookup: Dictionary[String, String] = {
	...
	"Analysis Squared":"res://Scenes/Relics/AnalysisSquared.tscn",
	...
	"Mentorship":"res://Scenes/Relics/Mentorship.tscn",
	"Mutualism":"res://Scenes/Relics/Mutualism.tscn",
	"Proper Documentation":"res://Scenes/Relics/ProperDocumentation.tscn",
	"Remaster In Rust":"res://Scenes/Relics/RemasterInRust.tscn",
	...
	"Support Circle":"res://Scenes/Relics/Supportcircle.tscn",
